import { domBinder, miniframe, DOMBindingSource } from "../src";
...
const view = state<(typeof views)[keyof typeof views] | null>(null);
...
} as const satisfies DOMBindingSource;
...
} as const satisfies Record<string, DOMBindingSource>;
